    ...
    #D. Drop-down Inputs: Select Filtering inputs 
    {
      ...
      #Select a Sub-Species
      {
        observeEvent(input$Select_SubSpecies, {
          ...
          NTreatments <- c() #Don't know why, but for some strange reason you need to define NTreatments up here (rather than ~100 lines later) or the whole app will crash in certain circumstances
