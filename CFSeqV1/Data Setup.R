...
#4. KEGG_Data: Contains KEGG pathway info for compatible bacterial strains. Currently, this includes: PA14, ...
...
#5. Perform DE Analysis By Species (Stored in CFSeq_Data)
{
  #---
  #Aspergillus fumigatus
  {
